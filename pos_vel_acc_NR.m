% Function computing position using Newton-raphson, then computing
% velocities and accelerations

%Inputs:
% C_fun - constraint function
% Cq_fun - jacobian
% Ct_fun - time derivateive of constraint function
% Ctt_fun - second time derivateive of constraint function
% tend - end time of simulation, from 0
% q_0 - initial position vector
% dt - time step
